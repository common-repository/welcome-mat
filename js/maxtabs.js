...
maxTabs.prototype.init = function() 
{
	this.tabs(); 
	this.previewTab();
	$(document).on('maxTabChange', $.proxy(this.setActive, this));
	this.checkActive();
}
...
maxTabs.prototype.tabs = function () 
{
	...
	var main_parent = '#maxinbound'; // the boss of the page, used for view selectors.
	...
	$.each($(tabs), function () 
	{
		...
		var tab = $('<a class="nav-tab">' + tab_title + '</a>'); 
...
maxTabs.prototype.setActive = function (e, tab) 
{
   var currentUrl = window.location.href;
   window.location.hash = tab; 
}

maxTabs.prototype.checkActive = function () 
{
...
maxTabs.prototype.togglePreview = function(show) {
	...
	if (typeof show == 'undefined') 
	{
		...
		if(!localStorage.getItem('mi-col-preview')) {
				this.togglePreview(true);
		
		}
		else
		{
			var preview = localStorage.getItem('mi-col-preview');
	...
	else if (show) 
	{
	    ...
	    localStorage.setItem('mi-col-preview', true);			
	...
	else
	{
	    ...
	    localStorage.setItem('mi-col-preview', false);	
	}

...
class DomNode implements IQuery {
	...
	/*	global $i; 
		...
		if ($attr == 'class')
		{
		echo "<P><PRE>"; var_dump(debug_backtrace(DEBUG_BACKTRACE_IGNORE_ARGS, 20)); echo "</PRE></p>"; 
//array_walk(debug_backtrace(DEBUG_BACKTRACE_IGNORE_ARGS, 20),create_function('$a,$b','print "{$a[\'function\']}()(".basename($a[\'file\']).":{$a[\'line\']}); ";'));
		if ($i > 10) 
			exit('F');
		$i++; 	
		}	*/
